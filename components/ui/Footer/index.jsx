        ...
        <div className="custom-screen text-gray-600">
            <div className="flex flex-wrap gap-y-10 items-center justify-between">
                <div className="space-y-4">
                    ...
                    <h2 className="text-gray-800 text-lg font-semibold sm:text-2xl">Deploy, Automate, Manage & Secure Your Public & Private Cloud Network Operations</h2>
            ...
            <div className="mt-10 py-10 border-t flex-row-reverse items-center justify-between sm:flex">
                ...
                <p className="mt-6 sm:mt-0">© 2024 Panaptico Inc. All rights reserved.</p>
            </div>
        </div>
    </footer>
)
