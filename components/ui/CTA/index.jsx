...
import cta_image from '../../../public/cuberto.jpeg'
        ...
        <SectionWrapper id="cta" className="overflow-hidden">
            <div className="custom-screen flex flex-col-reverse gap-x-12 justify-between md:flex-row md:items-center">
                <div className="flex-none max-w-xl mt-12 space-y-3 md:mt-0">
                    ...
                    Simple powerful way to unify access and usage of all cloud resources and applications.
                    </h2>
                    <p className="text-gray-600">
                        Panaptico containerizes your workloads, resources and applications in private networks securing them from unauthorized access, misuse, abuse of your most critical systems.
                    </p>
                    <div className="pt-1">
                        <NavLink
                            href="/pricing"
